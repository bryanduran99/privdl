...
尝试更多的公开数据集 去复现私有数据集的结果
facescrub 人比较少 测试集只取了 50+50 人'''
...
def split_dataset(dataset):
    ...
    trainset, testset_by_person = hubble_utils.split_dataset_by_person(
        dataset, test_id_num=50, test_img_per_id=50)
    trainset, testset_by_img = hubble_utils.split_dataset_by_img(
        trainset, test_id_num=50, test_img_per_id=50, train_scale=1.5)
