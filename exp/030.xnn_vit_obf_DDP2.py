...
class XnnParts_ViT:
    ...
    def extractor(self):
        ...
        state_dict = tc.load(self.ext, map_location=tc.device('cpu'))
...
#         'data_used', ['celeba', 'imdb', 'facescrub', 'msra', 'webface'])
    ...
    def train_vit_ext():  # 脱敏回流训练
        ...
        tc.save(model_lit.get_tail().state_dict(), f'{work_dir}/train_ext/ext.pk')
        return f'{work_dir}/train_ext/ext.pk'
...
# # Bash运行
    ...
    # CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python3 -m torch.distributed.launch --nproc_per_node 8 030.xnn_vit_obf_DDP2.py --train_dataset "webface" --client_dataset "msra"
