...
class XnnParts_mid_conv:
    ...
    def extractor(self):
        ...
        if self.pretrain_ckpt is not None:
            ...
            print('pretrain_ckpt is None for XnnParts_mid_conv')
        return head
    ...
    class PretrainModelLit(block.model.light.ModelLight):
        ...
        def __init__(self, pretrain_ckpt):
            ...
            if pretrain_ckpt is not None:
                ...
                print('pretrain_ckpt is None for PretrainModelLit')
            self.model = model
...
def main():
    ...
    pretrain_ckpt = None # f'{exp_utils.data_path()}/model/celeba_pretrain.tar'
    batch_size = 128
    num_workers = 8
