...
class XNN_Single_Lit(block.model.light.ModelLight):
    ...
    def __init__(self, class_num, isobf=True, pretrained_path='', split_layer=6, ext_test=False, is_permute=True, is_matrix=True):
        super().__init__()
        self.isobf = isobf
        self.is_permute = is_permute
        self.is_matrix = is_matrix
...
def main():
    ...
    # parser.add_argument("--run_mode", default="xnn", type=str)
