...
B @ k*k conv；k = 1, 3, 9, 27, 81
论证直接在原图上随机卷积 混淆是 不安全 但 可学性好 的
...
class XnnParts:
    ...
    def __init__(self, pretrain_ckpt, kernel_size):
...
def main():
    ...
    work_dir = f'{result_path}/kernel_size_{obf_kernel_size}'
    # 配置数据集 和 相应的预训练模型
    ...
    xnn_parts = XnnParts(pretrain_ckpt, obf_kernel_size)
